...
class EventData extends Data
{
    public function __construct(
        ...
        /** @var EventAdvancedSettingsData|null The advanced settings for this event */
        public readonly ?EventAdvancedSettingsData $advancedSettings = null,

        /** @var array<int, EventClassData>|null The classes that are applied to this event */
        #[DataCollectionOf(EventClassData::class)]
        public readonly ?array $classes = null,

        /** @var array<int, EventRoleData>|null The roles that are applied to this event */
        #[DataCollectionOf(EventRoleData::class)]
        public readonly ?array $roles = null,

        /** @var array<int, SignUpData>|null The current sign-ups on this event */
        #[DataCollectionOf(SignUpData::class)]
