...
class InvalidClassException extends NotFoundException implements BlizzardRequestException
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct(
            $response,
            "Playable class not found: {$this->method} {$this->endpoint} (status {$this->blizzardStatus})",
            $this->blizzardStatus,
            $previous,
        );
    }
