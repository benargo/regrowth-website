...
class StoreReportLinksRequestTest extends TestCase
{
    ...
    #[Test]
    public function rules_requires_codes_array(): void
    {
    ...
    #[Test]
    public function rules_requires_each_code_to_be_a_string_that_exists_in_reports(): void
    {
        $report = \Mockery::mock(Report::class);
        $report->shouldReceive('getAttribute')->with('code')->andReturn('ABC123');
    ...
    #[Test]
    public function rules_excludes_current_report_code(): void
    {
        $report = \Mockery::mock(Report::class);
    ...
    #[Test]
    public function rules_excludes_null_when_report_has_no_code(): void
    {
        $report = \Mockery::mock(Report::class);
