...
class SignUpDataTest extends TestCase
{
    #[Test]
    public function it_constructs_from_a_minimal_payload(): void
    {
        $signup = SignUpData::from($this->minimalPayload());
    ...
    {
        $signup = SignUpData::from($this->serverEventsPayload());
    ...
    {
        $signup = SignUpData::from($this->fullPayload());
    ...
    {
        $signup = SignUpData::from([...$this->fullPayload(), 'status' => 'primary']);
    ...
    {
        $signup = SignUpData::from([...$this->fullPayload(), 'position' => 5]);
    ...
    {
        $array = SignUpData::from($this->fullPayload())->toArray();
