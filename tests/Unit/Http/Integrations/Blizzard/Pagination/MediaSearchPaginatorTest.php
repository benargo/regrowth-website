...
class MediaSearchPaginatorTest extends BlizzardTestCase
{
    private function page1Response(): MockResponse
    {
        return MockResponse::make(body: [
            ...
            'results' => [
                ['data' => ['id' => 1, 'value' => 'https://render.example.com/icon1.jpg']],
                ['data' => ['id' => 2, 'value' => 'https://render.example.com/icon2.jpg']],
            ],
        ], status: 200);
    }
    ...
    private function page2Response(): MockResponse
    {
        return MockResponse::make(body: [
            ...
            'pageCount' => 2, 'resultCount' => 3,
            'results' => [
                ['data' => ['id' => 3, 'value' => 'https://render.example.com/icon3.jpg']],
            ],
        ], status: 200);
    }
    ...
    #[Test]
    public function it_exposes_metadata_from_last_response(): void
    {
        Saloon::fake([
            'eu.battle.net/oauth/token' => $this->tokenMock(),
            $this->page1Response(),
        ...
        // Exhaust the paginator so currentResponse is set to the last page
