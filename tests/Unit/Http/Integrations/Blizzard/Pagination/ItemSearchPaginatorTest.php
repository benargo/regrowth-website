...
class ItemSearchPaginatorTest extends BlizzardTestCase
{
    ...
    public function it_iterates_through_multiple_pages(): void
    {
        Saloon::fake([
            ...
            // Positional entries are served sequentially regardless of request class
            $this->page1Response(),
            $this->page2Response(),
        ]);
