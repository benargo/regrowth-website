...
class DifficultyTest extends TestCase
{
    ...
    {
        $difficulty = DifficultyData::from(['id' => 4, 'name' => 'Heroic', 'sizes' => [10, 25]]);
    ...
    {
        $difficulty = new DifficultyData(id: 4, name: 'Heroic', sizes: [10, 25]);
    ...
    {
        $difficulty = new DifficultyData(id: 1, name: 'Normal');
    ...
    {
        $difficulty = new DifficultyData(id: 3, name: 'Mythic', sizes: [20]);
