...
#[Group('comments')]
#[Group('broadcasting')]
class CommentChangedTest extends TestCase
{
    #[Test]
    #[Group('contract')]
    ...
    #[Test]
    #[Group('contract')]
    public function it_broadcasts_as_comment_changed(): void
    {
        $comment = $this->commentOn($this->itemWithId(1));

        $this->assertSame('CommentChanged', (new CommentChanged($comment))->broadcastAs());
    }
