...
function PriorityItem({ priority }) {
    return (
        <div className="border-primary bg-surface flex w-auto items-center justify-center gap-2 rounded-md border px-4 py-3">
...
function PriorityDisplay({ priorities }) {
    ...
    const rowBgs = ["bg-surface-sunken/60", "bg-surface/60", "bg-surface-raised/60", "bg-surface-highlight/60"];
    ...
    return (
        <div className="overflow-hidden rounded-md text-lg">
            {weights.map((weight, weightIndex) => (
                <div key={weight}>
                    {weightIndex > 0 && (
                        <div className="flex justify-center py-1 text-2xl text-accent-hover/60">
                    ...
                    >
                        <div className="flex h-8 w-8 flex-none items-center justify-center rounded-full border border-line text-lg font-bold text-line">
                            {weightIndex + 1}
                        </div>
                                ...
                                <div key={`priority-${priority.id}`} className="flex items-center gap-2">
                                    {index > 0 && (
                                        <Icon
                                            ...
                                            icon="equals"
                                            style="solid"
                                            className="flex-none text-2xl font-bold text-line"
                                        />
                                    )}
