        ...
        <div ref={containerRef} className="relative">
            <div className="relative">
                ...
                <input
                    ...
                    disabled={disabled}
                    className={`w-full rounded border border-line bg-surface py-2 pl-10 pr-10 text-white placeholder-gray-500 focus:outline-hidden focus:ring-1 focus:ring-focus-ring ${disabled ? "cursor-not-allowed opacity-75" : ""}`}
                />
            ...
            {!disabled && isOpen && filtered.length > 0 && (
                <ul className="absolute z-50 mt-1 max-h-48 w-full overflow-y-auto rounded border border-line bg-surface shadow-lg">
                    {filtered.map((character) => (
                        <li key={character.id}>
                            <button
                                type="button"
                                onClick={() => handleSelect(character)}
                                className="w-full px-4 py-2 text-left text-sm text-white transition-colors hover:bg-surface-raised"
                            >
                                {character.name}
                            </button>
                        </li>
        ...
        <Master title={pageTitle}>
            ...
            <FormContainer maxWidth="lg">
                    <form onSubmit={submit} className="flex flex-col gap-6">
                        ...
                        {multipleCharacters && (
                            <div className="rounded border border-line bg-surface/50 px-4 py-3">
                                <p className="text-md mb-3 text-body-bright">
                                    ...
                                    {multipleCharacters.map((c) => (
                                        <li key={c.id}>
                                            <button
                                                ...
                                                className="w-full rounded px-3 py-2 text-left text-sm text-white transition-colors hover:bg-surface-raised"
                                            >
                                                {c.name}
                                            </button>
                                        </li>
