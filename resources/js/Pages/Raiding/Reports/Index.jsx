                    ...
                    <Can permission="manage-reports">
                        <div className="mb-4 flex justify-end">
                            <Link
                                ...
                                className="inline-flex items-center gap-2 rounded-md border border-transparent bg-ink-600 px-4 py-2 text-sm font-semibold uppercase tracking-widest text-white transition hover:bg-ink-700 focus:outline-hidden focus:ring-2 focus:ring-ink-500 focus:ring-offset-2"
                            >
