                ...
                <div className="flex flex-col items-center gap-2 text-center">
                    {boss.assignments?.count > 0 ? (
                        <div className="flex w-full flex-col items-start gap-4">
                            <h2 className="flex-1 text-lg font-semibold text-body-muted">Assignments</h2>
        ...
        <Master title={event.title}>
            ...
            <PageContainer>
                ...
                {event.assignments.count > 0 && (
                    <div className="mb-8">
                        <h2 className="text-md mb-2 font-semibold tracking-wider text-body-muted/80 uppercase">
                            General Assignments
                        </h2>
                        <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-3">
