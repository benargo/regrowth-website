                    ...
                    <div className="mb-8 flex items-center gap-4">
                        {character.playable_class?.icon_url && (
                            <img
                                ...
                                className="h-12 w-12 rounded-lg border border-camel-600/30 shadow-lg shadow-black/40"
                            />
                        )}
                        <div>
                    ...
                    <div className="space-y-8 lg:max-w-2xl">
                        ...
                        <section>
                            ...
                            <p className="mb-4 text-sm text-gray-400">
                                ...
                                <span className="inline-flex items-center gap-1 text-camel-500">
                                    raid spec
                                </span>
                                .
                            </p>
                        ...
                        <section>
                            ...
                            <label className="flex cursor-pointer items-center gap-3 rounded border border-forever-600 bg-forever-800/30 px-4 py-3 transition-colors hover:border-forever-500">
                                <input
                                    type="checkbox"
                                    checked={data.is_loot_councillor}
                                    onChange={(e) => setData("is_loot_councillor", e.target.checked)}
                                    className="h-4 w-4 rounded border-camel-600 bg-forever-900 text-camel-600 focus:ring-camel-500 focus:ring-offset-0"
                                />
                        ...
                        {/* Actions */}
                        <div className="flex items-center gap-4 border-t border-forever-600 pt-6">
