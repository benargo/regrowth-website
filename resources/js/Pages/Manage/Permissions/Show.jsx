        ...
        <Master title="Manage Permissions">
            ...
            <PageContainer>
                ...
                <nav className="mb-6">
                    <Dropdown>
                        <Dropdown.Trigger>
                            <button className="flex items-center justify-between rounded border border-line px-4 py-2 text-line transition-colors hover:bg-accent/20">
                        ...
                        <Dropdown.Content align="left" width="48">
                            <div className="rounded-md border border-line bg-surface shadow-lg">
                                {groups.map((group) => (
                                    <Dropdown.Link
                                        key={group.slug}
                                        href={route("management.permissions.group.show", { group: group.slug })}
                                        className={group.active ? "bg-surface" : ""}
                                    >
                                        {group.name}
                                    </Dropdown.Link>
                                ))}
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {discordRoles.map((role) => {
                                ...
                                return (
                                    <tr key={role.id} className="border-b border-line/30 hover:bg-accent/10">
