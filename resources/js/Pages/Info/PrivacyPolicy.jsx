...
export default function PrivacyPolicy() {
    return (
        <Master title="Privacy Policy">
            ...
            <PageContainer>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <h2 className="font-lg mb-2 text-secondary-400">Topics:</h2>
                    <ol className="mb-4 list-inside list-decimal text-secondary-400">
                        <li>
                    ...
                    <a name="1"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">What data do we collect?</h2>
                    <p className="font-md mb-2 text-secondary-400">Regrowth collects the following data:</p>

                    <ul className="mb-4 list-inside list-disc text-secondary-400">
                        <li>
                    ...
                    <a name="2"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">How do we collect your data?</h2>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="3"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">How will we use your data?</h2>
                    <p className="font-md mb-2 text-secondary-400">Regrowth collects your data so that we can:</p>
                    ...
                    <a name="4"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">How do we store your data?</h2>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="5"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">What are your data protection rights?</h2>
                    ...
                    <a name="6"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">Cookies</h2>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="7"></a>
                    <h3 className="font-md mb-2 text-secondary-400">How do we use cookies?</h3>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="8"></a>
                    <h3 className="font-md mb-2 text-secondary-400">What types of cookies do we use?</h3>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="9"></a>
                    <h3 className="font-md mb-2 text-secondary-400">How to manage cookies</h3>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="10"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">Privacy policies of other websites</h2>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="11"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">Changes to our privacy policy</h2>
                    <p className="font-md mb-2 text-secondary-400">
                    ...
                    <a name="12"></a>
                    <h2 className="font-lg mb-2 text-secondary-400">How to contact us</h2>
                    <p className="font-md mb-2 text-secondary-400">
