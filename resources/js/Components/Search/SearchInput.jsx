    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                dusk={dusk}
                className="border-ink-500 bg-ground-800 w-full rounded border py-2 pr-10 pl-10 text-white placeholder-gray-500 focus:ring-1 focus:ring-ink-500 focus:outline-hidden"
            />
            {value && (
                <button
                    onClick={() => onChange("")}
