    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                dusk={dusk}
                className="border-focus-ring bg-surface w-full rounded border py-2 pr-10 pl-10 text-white placeholder-gray-500 focus:ring-1 focus:ring-focus-ring focus:outline-hidden"
            />
            {value && (
                <button
                    onClick={() => onChange("")}
