        ...
        <div ref={containerRef} className="relative">
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full rounded border border-camel-600 bg-forever-800 py-2 pl-10 pr-10 text-white placeholder-gray-500 focus:outline-hidden focus:ring-1 focus:ring-camel-500"
                />
                {isLoading && (
            ...
            {isOpen && !isLoading && results.length === 0 && query.trim() && (
                <div className="absolute z-50 mt-1 w-full rounded border border-camel-600 bg-forever-800 px-4 py-2 text-sm text-gray-400 shadow-lg">
                    No members found
                </div>
            )}
